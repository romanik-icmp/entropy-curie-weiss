...
\begin{figure}[H]
	%\isPreprints{}{% This command is only used for ``preprints''.
		...
		%\subfloat[\centering]{\includegraphics[width=7.0cm]{Definitions/logo-mdpi}}
		\subfloat[\centering]{\includegraphics[width=7.0cm]{images/entropy_per_cell_vs_mu4}}
		%\hfill
		%\subfloat[\centering]{\includegraphics[width=7.0cm]{Definitions/logo-mdpi}}
		\subfloat[\centering]{\includegraphics[width=7.0cm]{images/entropy_per_cell_vs_rho4}}
		%\isPreprints{}{% This command is only used for ``preprints''.
		\end{adjustwidth}
		%} % If the paper is ``preprints'', please uncomment this parenthesis.
